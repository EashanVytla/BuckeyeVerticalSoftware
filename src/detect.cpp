...
int detect::inference(int argc, char** argv) {
    ...
    if (isVideo) {
        ...
        // Initialize the VideoWriter object (change the filename and codec as needed)
        cv::VideoWriter writer("output.mp4", cv::VideoWriter::fourcc('H', '2', '6', '5'), fps, frameSize, true);//can change to MP4 format here instead of H.265
