...
int main(int argc, char** argv)
{
    ...
    auto result = mavsdk.add_any_connection(PHYSICAL_PORT_PATH);
    ...
    auto ret = camera_server.set_information({
        ...
        .horizontal_resolution_px = 1280,
        .vertical_resolution_px = 720,
        .lens_id = 0,
        .definition_file_version = 0, // TODO: add this
        .definition_file_uri = "rtsp://192.168.144.25:8554/main.264", // TODO: implement this using MAVLink FTP
    });
