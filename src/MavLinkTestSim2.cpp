...
//40.0084244,-83.0175219,40.0085887,-83.0175251,40.0085853,-83.0173310, 40.0084330, -83.0173369}
...
double targetLatitude, double targetLongitude, double coordinates[])
{
    ...
    switch (current_state) {
        ...
        //     }
            ...
            std::cout << "telemetry.pos().lat " << telemetry.position().latitude_deg << std::endl;
            std::cout << "telemetry.pos().log " << telemetry.position().longitude_deg << std::endl;
            std::cout << "target lat " << targetLatitude << std::endl;
            std::cout << "target long " << targetLongitude << std::endl;
            std::cout << std::endl;
...
int main()
{
    ...
    double coordinates[] = {
        ...
        telemetry.position().latitude_deg + (TEN_METERS_APPROX), 
        telemetry.position().longitude_deg, 

        telemetry.position().latitude_deg + (TEN_METERS_APPROX), 
        telemetry.position().longitude_deg + (TEN_METERS_APPROX), 
